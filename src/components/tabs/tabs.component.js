...
class Category extends Component {
  ...
  static getBackgroundStyle(url) {
    var styleUrl = `style="background-image: url(${url}); background-repeat: no-repeat;background-size: contain;`;
    styleUrl = url.endsWith("dev.gif") ? styleUrl + 'background-position-x: -220px;"' : styleUrl;
    return styleUrl + '"' 
  }
